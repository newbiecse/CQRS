    ...
    IIntegrationEventMapper integrationEventMapper) : IOrderWriteRepository
{
    ...
    private static OrderWriteEntity ToEntity(Order order) =>
        new()
        {
            Id = order.Id,
    ...
    private static IEnumerable<OrderLineWriteEntity> ToLineEntities(Order order) =>
    ...
    private static Order ToAggregate(OrderWriteEntity entity, IReadOnlyList<OrderLineWriteEntity> lines)
    {

...
public sealed class SqlCartReadRepository(ReadDbContext dbContext) : ICartReadRepository
{
    ...
    private static CartReadModel ToReadModel(CartReadEntity entity) =>
        new()
        {
            Id = entity.Id,
            ...
            Items = entity.Lines.Select(l => new OrderLineDto(

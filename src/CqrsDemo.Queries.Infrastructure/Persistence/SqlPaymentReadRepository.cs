...
public sealed class SqlPaymentReadRepository(ReadDbContext dbContext) : IPaymentReadRepository
{
    ...
    private static PaymentReadModel ToReadModel(PaymentReadEntity entity) =>
        new()
        {
            Id = entity.Id,

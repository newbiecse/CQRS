-- Auto-generated from EF Core models. Database: CqrsDemo_Write
IF NOT EXISTS (SELECT 1 FROM sys.databases WHERE name = N'CqrsDemo_Write')
    CREATE DATABASE [CqrsDemo_Write];
GO
...
CREATE INDEX [IX_StoredEvents_StreamId_StreamType] ON [StoredEvents] ([StreamId], [StreamType]);
GO
